...
impl Unlit {
    pub fn new(color: Vec4, texture: Option<AssetHandle<TextureAsset>>) -> Self {
        let bind_group = Some(Graphics::global_read().device.create_bind_group(
                ...
                entries: &[
                    ...
                    wgpu::BindGroupEntry {
                        ...
                        resource: wgpu::BindingResource::Buffer(wgpu::BufferBinding {
                            buffer: &Graphics::global_read().device.create_buffer_init(
                        ...
                        resource: wgpu::BindingResource::Buffer(wgpu::BufferBinding {
                            buffer: &Graphics::global_read().device.create_buffer_init(
                                &wgpu::util::BufferInitDescriptor {
                                    ...
                                    contents: bytemuck::cast_slice(&[if texture.is_some() {
                                        1u32
                                    } else {
                                        0u32
                                    }]),
    ...
    Graphics::global_read()
        ...
        .create_render_pipeline(&wgpu::RenderPipelineDescriptor {
            ...
            fragment: Some(wgpu::FragmentState {
                module: &shader,
                entry_point: "fs_main",
                targets: &[Some(Graphics::global_read().output_color_format.into())],
            }),
